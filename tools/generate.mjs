...
const MULTI_CITY_SOURCES = [/^https:\/\/(www\.)?comehome\.fun\//, /^https:\/\/(www\.)?weroad\.(it|com)\/wemeet\//, /^https:\/\/(www\.)?meeters\.org\//, /^https:\/\/(www\.)?tabloapp\.com\//, /^https:\/\/(www\.)?(lu\.ma|luma\.com)\//, /^https:\/\/share\.nomadtable\.app\//];
